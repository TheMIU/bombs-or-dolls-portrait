...
window.Sprites = {
  ...
  /**
   * Get SVG sprite for a Summit Flag
   * @param {number} player 0 (Neutral White) | 1 (Blue P1) | 2 (Red P2)
   */
  getFlag(player = 0) {
    if (player === 1) {
      // Vibrant Blue Team Summit Flag
      return `
      <svg viewBox="0 0 28 32" class="summit-flag-svg flag-svg-p1" xmlns="http://www.w3.org/2000/svg">
        <!-- Flagpole -->
        <line x1="5" y1="2" x2="5" y2="30" stroke="#475569" stroke-width="2.5" stroke-linecap="round"/>
        <!-- Golden Finial Knob -->
        <circle cx="5" cy="3" r="2.2" fill="#fbbf24" stroke="#d97706" stroke-width="0.8"/>
        <!-- Blue Pennant Banner -->
        <path d="M6 3.5 L26 10 L6 16.5 Z" fill="#0284c7" stroke="#0369a1" stroke-width="1.2" stroke-linejoin="round"/>
        <!-- Inner Highlight -->
        <path d="M7 5 L20 10 L7 14 Z" fill="#38bdf8" opacity="0.6"/>
        <!-- White Crest Star -->
        <polygon points="12,8 13.2,10.5 16,10.8 14,12.7 14.5,15.5 12,14.1 9.5,15.5 10,12.7 8,10.8 10.8,10.5" fill="#ffffff" opacity="0.95"/>
      </svg>`;
    }
    if (player === 2) {
      // Vibrant Red Team Summit Flag
      return `
      <svg viewBox="0 0 28 32" class="summit-flag-svg flag-svg-p2" xmlns="http://www.w3.org/2000/svg">
        <!-- Flagpole -->
        <line x1="5" y1="2" x2="5" y2="30" stroke="#475569" stroke-width="2.5" stroke-linecap="round"/>
        <!-- Golden Finial Knob -->
        <circle cx="5" cy="3" r="2.2" fill="#fbbf24" stroke="#d97706" stroke-width="0.8"/>
        <!-- Red Pennant Banner -->
        <path d="M6 3.5 L26 10 L6 16.5 Z" fill="#e11d48" stroke="#be123c" stroke-width="1.2" stroke-linejoin="round"/>
        <!-- Inner Highlight -->
        <path d="M7 5 L20 10 L7 14 Z" fill="#fb7185" opacity="0.6"/>
        <!-- White Crest Star -->
        <polygon points="12,8 13.2,10.5 16,10.8 14,12.7 14.5,15.5 12,14.1 9.5,15.5 10,12.7 8,10.8 10.8,10.5" fill="#ffffff" opacity="0.95"/>
      </svg>`;
    }
    // Neutral White/Silver Flag
    return `
    <svg viewBox="0 0 28 32" class="summit-flag-svg flag-svg-neutral" xmlns="http://www.w3.org/2000/svg">
      <!-- Flagpole -->
      <line x1="5" y1="2" x2="5" y2="30" stroke="#64748b" stroke-width="2.5" stroke-linecap="round"/>
      <!-- Silver Finial Knob -->
      <circle cx="5" cy="3" r="2" fill="#e2e8f0" stroke="#94a3b8" stroke-width="0.8"/>
      <!-- White Pennant Banner -->
      <path d="M6 3.5 L25 10 L6 16.5 Z" fill="#f8fafc" stroke="#94a3b8" stroke-width="1.2" stroke-linejoin="round"/>
      <!-- Subtle Fabric Fold -->
      <path d="M7 5 L18 10 L7 14 Z" fill="#e2e8f0" opacity="0.7"/>
    </svg>`;
  }
};
